...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="{{route('coupon.index')}}">Coupons</a> <a href="{{route('coupon.create')}}" class="current">Ajouter un nouveau Coupon</a> </div>
    <div class="container-fluid">
        ...
        <div class="widget-box">
            <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                <h5>Ajouter un nouveau Coupon</h5>
            </div>
            <div class="widget-content nopadding">
                <form action="{{route('coupon.store')}}" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label for="amount_type" class="control-label">Type montant </label>
                    ...
                    <div class="control-group">
                        <label for="expiry_date" class="control-label">Date d'expiration</label>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <button type="submit" class="btn btn-success">Ajouter un nouveau Coupon</button>
                        </div>
                    </div>
                </form>
            </div>
