...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="{{route('coupon.index')}}">Coupons</a> <a href="#" class="current">Modifier le Coupon</a> </div>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <form action="{{route('coupon.update',$edit_coupons->id)}}" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label for="amount_type" class="control-label"> Type de montant</label>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <button type="submit" class="btn btn-success">Mise à jour du Coupon</button>
                        </div>
                    </div>
                </form>
            </div>
