...
class UsersController extends Controller
{
    ...
    public function register(Request $request){
        ...
        return back()->with('message','Déjà inscrit!');
    }
    public function login(Request $request){
        ...
        if(Auth::attempt(['email'=>$input_data['email'],'password'=>$input_data['password']])){
            ...
            return back()->with('message','Le compte n/est pas valide!');
        }
    }
    ...
    public function updateprofile(Request $request,$id){
        ...
        return back()->with('message','Mettre à jour le profil déjà!');
    ...
    public function updatepassword(Request $request,$id){
        ...
        if(Hash::check($input_data['password'],$oldPassword->password)){
            ...
            return back()->with('message','Mettre à jour mot de passe déjà!');
        }else{
            return back()->with('oldpassword','Mot de passe ancien est Inconrrect!');
        }
    }
}
